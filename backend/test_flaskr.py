...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {
            'question': 'Why not just use Django?',
            'answer': 'I do not know, ask the instructor',
            'difficulty': 5,
            'category': '4'
        }
    ...
    def test_get_question_page_error(self):
    ...
    def test_delete_failed_question_does_not_exist(self):
    ...
    def test_search_with_no_results(self):
        res = self.client().post('/questions', json={'searchTerm': 'xdzzzdssaoe'})
        data = json.loads(res.data)
